...
-----------------------------------------
     ...
     */
        ...
        System.out.println("Ehliyetiniz varsa 1, yoksa 0 yaziniz: ");
        int ehliyet = scan.nextInt();
        if (ehliyet == 0 || ehliyet == 1) {//ehliyet varlik yokluk sartina gore diger kosullar calisacak
            if(ehliyet==0){
            ...
            if (ehliyet == 1) {
                ...
                } else if (54 < hiz && hiz < 75) {
                    System.out.println("Ceza 100 $'dır.");

                } else if (75 <= hiz && hiz <= 84) {
                    System.out.println("Ceza 150 $'dır.");

                } else if (85 <= hiz && hiz <= 94) {
                    System.out.println("Ceza 320 $'dır.");
                } else if (hiz > 94) {
                    System.out.println("Ceza 500 $'dır.");
                }else System.out.println("hiz sinirinda seyahat ediyorsunuz");

            } else if (ehliyet == 0) {
                System.out.println("Ehliyetsiz araba kullanmanin cezasi extra 200 dolardir.");
                if(hiz <0){
                    System.out.println("hatali giris");
                }
                else if (55 < hiz && hiz < 74) {
                ...
                System.out.println("Hiz siniirnda gidiyorsunuz ancak ehliyetiniz yok");
            }
        }
    }
}
